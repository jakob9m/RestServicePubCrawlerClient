$(document).ready(function() {
	window.onload = function() {
		...
		document.getElementById("pubAddressHeader").innerText = "";
...
$(":button").click(function() {
		...
		if (this.id == "pubButton"){
			document.getElementById("pubInfo").innerText = this.name;
			var selectedPub = document.getElementById("pubInfo");
			selectedPub.setAttribute("value", this.name)
			document.getElementById("SP").innerText = this.name;
			document.getElementById("pubAddressHeader").innerText = this.value;
		}else if(this.id == "beerButton"){
			document.getElementById("selectedBeer").innerText = this.name;
			var selectedBeer = document.getElementById("SB");
			selectedBeer.setAttribute("value", this.value);
